...
const downloadAndSendMedia = async (m, Matrix) => {
  ...
  try {
    const supportedDomains = ['youtube.com', 'youtu.be', 'instagram.com', 'facebook.com', 'tiktok.com', 'drive.google.com', 'x.com', 'twitter.com', 'giftedtechnexus.co.ke', 'snapchat.com', 'likee.com', 'github.com'];
